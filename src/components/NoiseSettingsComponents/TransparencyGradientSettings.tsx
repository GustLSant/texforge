...
export default function TransparencyGradientSettings(props: TranspGradientSettingsProps){
  ...
  function handleChangeTranspGradients(_side: 'tb'|'bt'|'rl'|'lr'|'rad', _newValue: number): void{
    if(_side === 'tb'){
      ...
      const newTranspGradients: TranspGradientType = {...props.transpGradients}
      newTranspGradients.rad = _newValue
      props.setTranspGradients(newTranspGradients)
    }
  }


  function handleClickResetButton(_side: 'tb'|'bt'|'rl'|'lr'|'rad'){
    if(_side === 'tb'){
      const newTranspGradients: TranspGradientType = {...props.transpGradients}
    ...
    <section className="settings-section">
        ...
        <div className="settings-section__container-controls">
          <div className="setting-control-container">
            ...
            <input type="range" min={0.0} max={3.0} step={0.01} value={props.transpGradients.tb} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{handleChangeTranspGradients('tb', Number(e.target.value))}} />
          </div>
          ...
          <div className="setting-control-container">
            ...
            <input type="range" min={0.0} max={3.0} step={0.01} value={props.transpGradients.bt} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{handleChangeTranspGradients('bt', Number(e.target.value))}} />
          </div>
          ...
          <div className="setting-control-container">
            ...
            <input type="range" min={0.0} max={3.0} step={0.01} value={props.transpGradients.rl} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{handleChangeTranspGradients('rl', Number(e.target.value))}} />
          </div>
          ...
          <div className="setting-control-container">
            ...
            <input type="range" min={0.0} max={3.0} step={0.01} value={props.transpGradients.lr} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{handleChangeTranspGradients('lr', Number(e.target.value))}} />
          </div>

          <div className="setting-control-container">
            <div className="setting-label-container">
              <p>Radial:</p>
              <div className="flex gap-1 items-center"><p>{props.transpGradients.rad}</p><TbReload className="text-xl" onClick={()=>{handleClickResetButton('rad')}} /></div>
            </div>
            <input type="range" min={0.0} max={3.0} step={0.01} value={props.transpGradients.rad} onChange={(e:React.ChangeEvent<HTMLInputElement>)=>{handleChangeTranspGradients('rad', Number(e.target.value))}} />
          </div>
        </div>
    </section>
  )
